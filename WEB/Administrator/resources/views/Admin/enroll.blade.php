  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">DATA ENROLl</h5>
        ...
        <form class="form-horizontal" id="EditForm" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <div class="input-group input-group-sm">
                  <input type="text" name="active" id="eactive"  class="form-control" placeholder="max 250 char" required>
                </div>
              </div>
